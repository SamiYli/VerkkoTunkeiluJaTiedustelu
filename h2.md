...
```
![Ladataan apache](imgesh2/install_apache2.JPG)
...
```
![webiste log](imgesh2/website_log.JPG)
```
...
nmap -A localhost
```
![nmap_webserver](imgesh2/nmap_webserver.JPG)
...
![wireshark_capture](imgesh2/wireshark_capture.JPG)
...
http contains "nmap"
```
![http_contains_nmap](imgesh2/http_contains_nmap.JPG)
...
![Get_packet2](imgesh2/get_packet2.JPG)
...
![nmap_different_userAgent](imgesh2/nmap_different_userAgent.JPG)
...
![nmap_different_userAgentlogs](imgesh2/nmap_different_userAgent2.JPG)

Nyt ei näy nmap user-agenttia ollenkaan.

![ngrep_dif_userAgent2](imgesh2/ngrep_dif_userAgent2.JPG)
